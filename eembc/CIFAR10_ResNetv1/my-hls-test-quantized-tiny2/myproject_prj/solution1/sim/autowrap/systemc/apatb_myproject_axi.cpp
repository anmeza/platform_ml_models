...
output_axi_t out[10])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *out_data_pc_buffer = new sc_bv<32>[10];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_data
				{
					...
					// {
						...
						// {
							sc_lv<32>* out_data_lv0_0_9_1 = new sc_lv<32>[10];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: out.data(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 9; i_0 += 1)
							{
								...
								{
									out_data_lv0_0_9_1[hls_map_index].range(31, 0) = sc_bv<32>(out_data_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: out.data(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 9; i_0 += 1)
							{
								...
								// output_type_conversion : (out_data_lv0_0_9_1[hls_map_index]).to_uint64()
								if (&(out[0].data) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&out[i_0].data = (out_data_lv0_0_9_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* in_data_tvin_wrapc_buffer = new sc_bv<32>[3072];
		...
		tcl_file.set_num(3072, &tcl_file.in_data_depth);
		...
		sc_bv<1>* in_last_V_tvin_wrapc_buffer = new sc_bv<1>[3072];
		...
		tcl_file.set_num(3072, &tcl_file.in_last_V_depth);
		...
		sc_bv<32>* out_data_tvin_wrapc_buffer = new sc_bv<32>[10];
		...
		tcl_file.set_num(10, &tcl_file.out_data_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* out_data_tvout_wrapc_buffer = new sc_bv<32>[10];
