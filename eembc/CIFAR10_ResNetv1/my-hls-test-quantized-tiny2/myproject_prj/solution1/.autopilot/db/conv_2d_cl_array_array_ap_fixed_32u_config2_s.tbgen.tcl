...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "kernel_data_V_2301", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "kernel_data_V_0", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "kernel_data_V_1300", "Type" : "OVld", "Direction" : "IO"},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_axi_mux_325_14_1_1_U9", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	conv_2d_cl_array_array_ap_fixed_32u_config2_s {
		...
		kernel_data_V_2301 {Type IO LastRead -1 FirstWrite -1}
		kernel_data_V_0 {Type IO LastRead -1 FirstWrite -1}
		kernel_data_V_1300 {Type IO LastRead -1 FirstWrite -1}
