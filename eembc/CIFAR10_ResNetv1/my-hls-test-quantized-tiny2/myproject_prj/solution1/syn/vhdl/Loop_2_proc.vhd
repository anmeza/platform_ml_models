...
architecture behav of Loop_2_proc is 
    ...
    signal tmp_103_reg_630 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_102_fu_376_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_429_i_fu_520_p3 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    myproject_axi_mux_104_8_1_1_U4538 : component myproject_axi_mux_104_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln935_reg_586 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                ...
                tmp_103_reg_630 <= m_2_fu_475_p2(25 downto 25);
            end if;
        end if;
    end process;
    ...
    p_Result_8_fu_527_p5 <= (m_6_fu_499_p1(63 downto 32) & tmp_429_i_fu_520_p3 & m_6_fu_499_p1(22 downto 0));
    ...
    select_ln964_fu_502_p3 <= 
        ap_const_lv8_7F when (tmp_103_reg_630(0) = '1') else 
        ap_const_lv8_7E;
    ...
    tmp_102_fu_376_p3 <= lsb_index_fu_317_p2(31 downto 31);
    tmp_429_i_fu_520_p3 <= (p_Result_6_reg_580 & add_ln964_fu_514_p2);
    tmp_V_4_fu_272_p3 <= 
    ...
    xor_ln949_fu_384_p2 <= (tmp_102_fu_376_p3 xor ap_const_lv1_1);
