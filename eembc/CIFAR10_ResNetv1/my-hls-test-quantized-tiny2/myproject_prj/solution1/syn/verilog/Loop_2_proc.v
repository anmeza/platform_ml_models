...
myproject_axi_mux_104_8_1_1 #(
    ...
    .din10_WIDTH( 4 ),
    .dout_WIDTH( 8 ))
myproject_axi_mux_104_8_1_1_U4538(
    .din0(tmp_data_V_0),
    .din1(tmp_data_V_1),
    .din2(tmp_data_V_2),
    .din3(tmp_data_V_3),
...
always @ (posedge ap_clk) begin
    if (((icmp_ln935_reg_586 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        ...
        tmp_103_reg_630 <= m_2_fu_475_p2[32'd25];
    end
end
...
assign p_Result_8_fu_527_p5 = {{m_6_fu_499_p1[63:32]}, {tmp_429_i_fu_520_p3}, {m_6_fu_499_p1[22:0]}};
...
assign select_ln964_fu_502_p3 = ((tmp_103_reg_630[0:0] === 1'b1) ? 8'd127 : 8'd126);
...
assign tmp_102_fu_376_p3 = lsb_index_fu_317_p2[32'd31];

assign tmp_429_i_fu_520_p3 = {{p_Result_6_reg_580}, {add_ln964_fu_514_p2}};
...
assign xor_ln949_fu_384_p2 = (tmp_102_fu_376_p3 ^ 1'd1);
