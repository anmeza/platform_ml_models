...
reg    ap_block_state3;
reg   [5:0] i1_0_reg_332;
reg    ap_block_state1;
reg   [5:0] j3_0_reg_343;
wire   [0:0] icmp_ln61_fu_354_p2;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln61_fu_354_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op117 == 1'b0)) | ((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op84 == 1'b0))) & (icmp_ln65_fu_366_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op117 == 1'b0)) | ((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op84 == 1'b0))) & (icmp_ln65_fu_366_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        j3_0_reg_343 <= j_fu_372_p2;
    end else if (((icmp_ln61_fu_354_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        j3_0_reg_343 <= 6'd0;
    end
end
...
always @ (*) begin
    if (((icmp_ln61_fu_354_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln65_fu_366_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if ((~(((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op117 == 1'b0)) | ((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op84 == 1'b0))) & (icmp_ln65_fu_366_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~(((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op117 == 1'b0)) | ((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op84 == 1'b0))) & (icmp_ln65_fu_366_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end
...
always @ (*) begin
    ap_block_state3 = (((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op117 == 1'b0)) | ((icmp_ln65_fu_366_p2 == 1'd0) & (io_acc_block_signal_op84 == 1'b0)));
end

assign ap_ready = internal_ap_ready;

assign i_fu_360_p2 = (i1_0_reg_332 + 6'd1);

assign icmp_ln61_fu_354_p2 = ((i1_0_reg_332 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln65_fu_366_p2 = ((j3_0_reg_343 == 6'd32) ? 1'b1 : 1'b0);
...
assign j_fu_372_p2 = (j3_0_reg_343 + 6'd1);
